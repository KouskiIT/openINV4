      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Button variant="outline" size="sm" onClick={handleExportExcel} className="bg-[#eefdf4]">
              <FileSpreadsheet className="mr-2 h-4 w-4" />
              Exporter Excel
            </Button>
            <Button variant="destructive" size="sm" onClick={onClearHistory} className="bg-[#f7d5d5] hover:bg-[#f0c5c5]">

...
export function AdvancedFilters({ filters, onFiltersChange, filterOptions }: AdvancedFiltersProps) {
  ...
  return (
    <Card className="mb-6">
      <CardHeader className="flex flex-col space-y-1.5 p-6 mt-[-18px] mb-[-18px] ml-[1px] mr-[1px] pl-[24px] pr-[24px] pt-[17px] pb-[17px]">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {filterOptions?.departments.filter(dept => dept && dept.trim() !== '').map((dept, index) => (
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {filterOptions?.categories.filter(cat => cat && cat.trim() !== '').map((cat, index) => (
